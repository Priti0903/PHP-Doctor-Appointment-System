...
// on b.patientPhone = a.patientPhone
$res = mysqli_query($con,"SELECT a.*, b.* FROM doctorschedule a INNER JOIN patient b
WHERE a.scheduleDate='$appdate' AND scheduleId=$appid AND b.patientPhone=$session");
...
$patientPhone = mysqli_real_escape_string($con,$userRow['patientPhone']);
...
$query = "INSERT INTO appointment (  patientPhone , scheduleId , appSymptom , appComment  )
VALUES ( '$patientPhone', '$scheduleid', '$symptom', '$comment') ";
										...
										<form class="form" role="form" method="POST" accept-charset="UTF-8">
											<div class="panel panel-default">
												...
												<div class="panel-body">
													...
													patient Phoneno.: <?php echo $userRow['patientPhone'] ?><br>
