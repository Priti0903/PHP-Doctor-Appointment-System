                ...
                <ul class="nav navbar-right top-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="patientupdateprofile.php?patientPhone=<?php echo $userRow['patientPhone']; ?>"><i class="fa fa-fw fa-user"></i> Update Profile</a>
                            </li>
                            <li>
                                        ...
                                        <div class="row">
                                            ...
                                            <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                                                <div class=" col-md-9 col-lg-9 ">
                                                    ...
                                                    <input type="hidden" name="patientPhone" value="<?php echo $userRow['patientPhone']; ?>" />
