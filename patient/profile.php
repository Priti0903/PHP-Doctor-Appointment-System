...
$res=mysqli_query($con,"SELECT * FROM patient WHERE patientPhone=".$_SESSION['patientSession']);
...
$res=mysqli_query($con,"UPDATE patient SET patientFirstName='$patientFirstName', patientLastName='$patientLastName', patientMaritialStatus='$patientMaritialStatus', patientDOB='$patientDOB', patientGender='$patientGender', patientAddress='$patientAddress', patientEmail='$patientEmail' WHERE patientPhone=".$_SESSION['patientSession']);
