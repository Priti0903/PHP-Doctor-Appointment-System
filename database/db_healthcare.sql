...
CREATE TABLE `appointment` (
  ...
  `patientPhone` bigint(12) NOT NULL,
...
INSERT INTO `appointment` (`appId`, `patientPhone`, `scheduleId`, `appSymptom`, `appComment`, `status`) VALUES
...
CREATE TABLE `doctor` (
  `DoctorAdhaar` bigint(12) NOT NULL,
...
INSERT INTO `doctor` (`DoctorAdhaar`, `password`, `doctorId`, `doctorFirstName`, `doctorLastName`, `doctorAddress`, `doctorPhone`, `doctorEmail`, `doctorDOB`) VALUES
(1234567890082587, '123', 123, 'Doctor', 'Sehgal', 'kuala lumpur', '0173567758', 'dsehgal@gmail.com', '1990-04-10');
...
INSERT INTO `patient` (`patientPhone`, `password`, `patientFirstName`, `patientLastName`, `patientMaritialStatus`, `patientDOB`, `patientGender`, `patientAddress`, `patientPhone`, `patientEmail`) VALUES
...
--
ALTER TABLE `appointment`
  ADD CONSTRAINT `appointment_ibfk_4` FOREIGN KEY (`patientPhone`) REFERENCES `patient` (`patientPhone`),
