...
$res = mysqli_query($con,"SELECT * FROM patient WHERE patientPhone = '$patientPhone'");
$row=mysqli_fetch_array($res,MYSQLI_ASSOC);
if ($row['password'] == $password)
{
$_SESSION['patientSession'] = $row['patientPhone'];
?>
...
//INSERT
$query = " INSERT INTO patient (  patientPhone, password, patientFirstName, patientLastName,  patientDOB, patientGender,   patientEmail )
VALUES ( '$patientPhone', '$password', '$patientFirstName', '$patientLastName', '$patientDOB', '$patientGender', '$patientEmail' ) ";
...
.                                        <div class="col-md-12">
                                            ...
                                            <form class="form" role="form" method="POST" accept-charset="UTF-8" >
                                                <div class="form-group">
                                                    <label class="text" for="patientPhone">patientPhone</label>
                                                    <input type="tel" class="form-control" name="patientPhone" placeholder="Patient Phoneno." pattern="[0-9]{10}" required>
                                                </div>
                                                <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <input type="tel" name="patientPhone" id="p_id" value="" class="form-control input-lg" placeholder="Phone number" pattern="[0-9]{10}"  required/>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        ...
                        <div class="col-xs-10">
                            <h4>Doctor Appointment Booking System:</h4>
                            <p>An online doctor appointment booking system can prove to be a boon to Doctors and patients alike. For those among us who have seen the waiting room of busy doctors, it will draw memories of patients and their attendants crowding around the receptionist. It was not necessarily first-in and first-out.</p>
                        </div>
                    </div>
